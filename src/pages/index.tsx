...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#233329] to-[#63D471]">
        <div className="h-[90vh] w-[90vw] rounded-lg bg-white p-8 shadow-lg sm:h-[30rem] sm:w-[30rem]">
